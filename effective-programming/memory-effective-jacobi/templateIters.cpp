...
template<>
inline void countStringIterations<0>(float* Phi, float* PhiN, const size_t nX, const size_t nXArr, const size_t jArr, 
  const __m256 vA, const __m256 vB, const __m256 vC, const float* D, const float A, const float B, const float C) {}
...
template<>
inline void initialIterations<0>(float* Phi, float* PhiN, const size_t nX, const size_t nXArr, const size_t jArr, 
  const __m256 vA, const __m256 vB, const __m256 vC, const float* D, const float A, const float B, const float C) {}
...
template<>
inline void endingIterations<0>(float* Phi, float* PhiN, const size_t nX, const size_t nXArr, const size_t jArrLimit, 
  const __m256 vA, const __m256 vB, const __m256 vC, const float* D, const float A, const float B, const float C) {}

template<size_t N>
inline void countIterations(float* Phi, float* PhiN, const size_t nX, const size_t nXArr, const size_t jArrLimit, 
  const __m256 vA, const __m256 vB, const __m256 vC, const float* D, const float A, const float B, const float C) {
  
  initialIterations<N>(Phi, PhiN, nX, nXArr, nXArr, vA, vB, vC, D, A, B, C);
  for (auto jArr = N*nXArr; jArr < jArrLimit; jArr+=nXArr)
    countStringIterations<N>(Phi, PhiN, nX, nXArr, jArr, vA, vB, vC, D, A, B, C);
